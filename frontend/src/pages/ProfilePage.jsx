...
<div className="min-h-screen bg-[var(--bg-primary)]">
    ...
    {activeTab === 'collabs' && (
        ...
        <div className="space-y-3">
            ...
            // Determine who to show as "the other person" in this collaboration.
            // If the profile user is the track owner, show the collaborator.
            // If the profile user is the collaborator, show the owner.
            const profileUserId = parseInt(profileId);
            const isOwnerOfTrack = collab.owner_id === profileUserId;
            ...
            <div key={collab.id} className="glass-panel p-4 rounded-xl hover:border-primary-500/50 transition-all">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <Link to={`/profile/${otherPersonId}`} className="font-semibold text-[var(--text-primary)] hover:text-primary-400 transition-colors text-sm">
                        {otherPersonName}
                        </Link>
                        <span className="px-1.5 py-0.5 bg-[var(--bg-tertiary)] text-[var(--text-tertiary)] text-xs rounded border border-[var(--border-color)]">
                        {roleLabel === 'Owner' ? 'their collab' : 'your collab'}
                        </span>
                    </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    {/* Only show message button when viewing someone else's profile */}

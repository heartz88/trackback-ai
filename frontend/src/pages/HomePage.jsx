...
<div className="min-h-screen bg-[var(--bg-primary)] ">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-24 lg:pt-32 lg:pb-32">
        ...
        {!user && (
            ...
            <Link
                to="/register"
                className="px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white text-lg font-semibold rounded-xl transition-[box-shadow,border-color] shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 hover:-translate-y-0.5"
            >
                Get Started Free
            </Link>
            <Link
    ...
    <section className="py-24">
        ...
        <div className="bg-gradient-to-br from-primary-500/10 to-primary-600/10 rounded-3xl p-12 border border-primary-500/20">
            ...
            <Link
            to="/register"
            className="inline-block px-10 py-5 bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 text-white text-lg font-semibold rounded-xl transition-[box-shadow,border-color] shadow-lg shadow-primary-500/25 hover:shadow-primary-500/40 hover:-translate-y-0.5"
            >
            Get Started Free →
            </Link>
        </div>

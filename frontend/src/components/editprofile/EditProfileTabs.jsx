            ...
            <div className="flex overflow-x-auto scrollbar-none border-b border-[var(--border-color)]/40">
                {TABS.map(tab => (
                    <button key={tab.id} onClick={() => onTabChange(tab.id)}
                        className="relative flex items-center gap-1.5 px-3 py-2.5 font-medium transition-all whitespace-nowrap text-sm flex-shrink-0 flex-1 justify-center group"

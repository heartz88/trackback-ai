...
// Drag-to-seek: pointerdown -> pointermove -> pointerup
...
<div className="timeline">
    ...
    aria-valuemax={100}
    >
    {/* Filled teal portion — sits above ::before track via z-index */}
    <div className="progress-bar" style={{ width: `${pct}%` }} />
    {/* Thumb — visible once loaded, not clipped because container has no overflow:hidden */}
    {duration > 0 && (
        <div style={{
        position: 'absolute',
        left: `${pct}%`,
        ...
        boxShadow: '0 0 0 3px rgba(20,184,166,0.25), 0 1px 4px rgba(0,0,0,0.4)',
        pointerEvents: 'none',
        zIndex: 3,

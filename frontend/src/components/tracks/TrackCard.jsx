...
// You can integrate with your audio player here
};
...
`}>
    ...
    <div className="flex items-start justify-between mb-4">
        ...
        <button
            ...
            className="absolute -bottom-1 -right-1 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center shadow-lg hover:bg-primary-400 transition-all transform hover:scale-110"
        >
            {isPlaying ? (
    ...
    {/* Desired Skills with Better Styling */}
    ...
    <div className="relative mb-4 group/audio">
        ...
        {/* Audio visualization overlay (optional) */}
    ...
    {track.collaboration_count > 0 && !isOwner && (
        ...
        <span>👥</span>
        <span>{track.collaboration_count} {track.collaboration_count === 1 ? 'person is' : 'people are'} working on this</span>
        </div>
    )}
    </div>
</div>

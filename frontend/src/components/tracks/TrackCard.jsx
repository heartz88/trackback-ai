...
setRequesting(true);
try {
    // ✅ FIXED: Send track.id as trackId to identify which track to collaborate on
    // The backend will look up the track owner from the tracks table
    const success = sendCollaborationRequest(track.id, `I'd like to collaborate on "${track.title}"`);

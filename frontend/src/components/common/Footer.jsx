...
<footer className="bg-[var(--bg-secondary)] border-t border-[var(--border-color)]">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 mb-12">
        ...
        <div className="flex gap-3">
            ...
            className="w-11 h-11 bg-[var(--bg-tertiary)] hover:bg-[var(--accent-primary)]/10 rounded-xl flex items-center justify-center transition-[box-shadow,border-color] duration-300 border border-[var(--border-color)] hover:border-[var(--accent-primary)]/50 group"
            >
